    ...
    <main className="mx-auto mb-24 max-w-7xl flex-col space-y-16 px-4 md:mb-32 md:space-y-24">
      ...
      <article className="space-y-4">
        ...
        <P>
          ...
          (Google or Discord). This includes your display name, email address, and profile picture.
          We also collect "Performance Data," which consists of your quiz responses, completion
          times, and streak history to calculate your global ranking.
        </P>
      </article>
      ...
      <article className="space-y-4">
        ...
        <P>
          ...
          use your profile information to personalize your dashboard and your performance metrics to
          generate live leaderboards. Your email is used only for essential account-related
      ...
      <article className="space-y-4">
        ...
        <P>
          ...
          industry-standard encryption and secure SSO protocols. While we implement robust measures
          to protect against unauthorized access in accordance with Pakistan’s data protection
          standards, no transmission over the internet can be guaranteed as 100% secure.
        </P>
      </article>
      ...
      <article className="space-y-4">
        ...
        <P>
          If you have any questions regarding this Privacy Policy or wish to exercise your rights to
          access or delete your personal data, please contact the developer directly at
          zain.khoso.dev@gmail.com. We aim to respond to all data-related inquiries within 72 hours.
        </P>
      </article>
    </main>
  );
