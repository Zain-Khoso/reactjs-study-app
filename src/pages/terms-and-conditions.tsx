  ...
  return (
    <main className="mx-auto mb-24 max-w-7xl flex-col space-y-16 px-4 md:mb-32 md:space-y-24">
      ...
      <article className="space-y-4">
        ...
        <P>
          To maintain a fair "Proof of Knowledge" environment, users are prohibited from using bots,
          scripts, or automated tools to answer questions. Any attempt to circumvent our real-time
          synchronization or manipulate server-side timers will result in a permanent ban of your
          SSO-linked account.
        </P>
      </article>
