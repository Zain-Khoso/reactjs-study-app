        ...
        <main className="mx-auto mb-24 max-w-7xl flex-col space-y-16 px-4 md:mb-32 md:space-y-24">
          ...
          <article className="space-y-4">
            ...
            <P>
              ...
              strive for accuracy across our 100k+ MCQ dataset, all content is provided "as-is." We
              do not guarantee that all questions are free from error or up to date with the latest
          ...
          <article className="space-y-4">
            ...
            <P>
              We use Third-Party SSO (Google, Discord, etc.) to verify identity and track rankings.
              By using Preplus, you consent to the collection of your performance data for the
              purpose of generating global leaderboards and percentile rankings accessible to the
              public.
            </P>
          </article>
          ...
          <article className="space-y-4">
            ...
            <P>
              For any legal inquiries, data removal requests, or reports of content inaccuracy,
              please contact the developer directly at zain.khoso.dev@gmail.com.
            </P>
          </article>
        </main>
      </motion.div>
