      ...
      <motion.div variants={generalPageMotions} initial="initial" animate="animate" exit="exit">
        ...
        <main className="mx-auto mb-24 max-w-7xl flex-col space-y-16 px-4 md:mb-32 md:space-y-24">
          ...
          <article className="space-y-4">
            <H3>2. Use of Data</H3>
            <P>
              Your data is used solely to maintain the competitive integrity of the Preplus Arena.
              We use your profile information to personalize your dashboard and your performance
              metrics to generate live leaderboards. Your email is used only for essential
              account-related communication and will never be sold to third parties.
            </P>
          </article>
          ...
          <article className="space-y-4">
            ...
            <P>
              Preplus utilizes local storage and essential cookies to maintain your active session
              and ensure real-time synchronization with our game servers. These technical "Strictly
          ...
          <article className="space-y-4">
            ...
            <P>
              ...
              rights to access or delete your personal data, please contact the developer directly
              at zain.khoso.dev@gmail.com. We aim to respond to all data-related inquiries within 72
              hours.
            </P>
          </article>
        </main>
